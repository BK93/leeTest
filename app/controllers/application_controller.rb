  ...
  protect_from_forgery with: :exception
    ...
    protected
      def configure_permitted_parameters
	    ...
	    devise_parameter_sanitizer.for(:account_update) { |u| u.permit(:username, :userId, :email, :password, :password_cofirmation, :current_password, :remember_me, :image, :image_cache) }
      end
